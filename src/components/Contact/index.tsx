...
import { NohemiBold, NohemiLight, NohemiRegular, NohemiSemiBold } from '@/lib/fonts';
...
const Contact = () => {
  ...
  return (
    <div className='w-full h-[100lvh] relative pb-12 flex flex-col contact'>
      ...
      <div className='w-full h-1/2 flex justify-end md:px-4 px-2 relative'>
        ...
        <div className='w-fit h-full flex flex-col justify-end pb-10'>
          <div className="text-right">
            <p className={cn('text-xs sm:text-lg lg:text-2xl contactText', NohemiRegular.className)}>Got a project in mind? let&apos;s work together </p>
            ...
            <p className={cn("text-xs sm:text-sm", NohemiLight.className)}>I am also available for full time roles</p>
          </div>
        </div>
      </div>
